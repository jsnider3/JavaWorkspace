...
public class TicTacToeGame {
	...
	private static void CLI() {
		...
		boolean playerFirst=sc.next().equals("Yes");//If the user types in Yes.
		...
		while(!DEFAULT_BOARD.isOver()){//While the game is not over
	...
	private static short getMove(){
		...
		while(move>8||move<0||!DEFAULT_BOARD.getEmptySpots().contains(move)){
